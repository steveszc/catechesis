...
export const Heidelberg: CatechismData = {
  metadata: {
    ...
    originStory: '',
    sourceUrl:
      'http://apostles-creed.org/wp-content/uploads/2014/07/Heidelberg-Catechism-with-Intro.pdf',
  ...
  data: [
    ...
    },
    {
      ...
      questionWithProofs:
        'Since there is only one God,[1] why do you speak of three persons, Father, Son, and Holy Spirit?',
      answer:
    ...
    },
    {
      ...
      answerWithProofs:
        'Because He saves us from all our sins,[1] and because salvation is not to be sought or found in anyone else.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'No. Though they boast of Him in words, they in fact deny the only Saviour Jesus.[1] For one of two things must be true: either Jesus is not a complete Saviour, or those who by true faith accept this Saviour must find in Him all that is necessary for their salvation.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        "Because Christ alone is the eternal, natural Son of God.[1] We, however, are children of God by adoption, through grace, for Christ's sake.[2]",
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'He is our Mediator,[1] and with His innocence and perfect holiness covers, in the sight of God, my sin, in which I was conceived and born.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'Though innocent, Christ was condemned by an earthly judge,[1] and so He freed us from the severe judgment of God that was to fall on us.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'Yes. Thereby I am assured that He took upon Himself the curse which lay on me, for a crucified one was cursed by God.[1]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'Because of the justice and truth of God[1] satisfaction for our sins could be made in no other way than by the death of the Son of God.[2]',
      proofs: [
        {
          id: 1,
          references: 'Gen. 2:17',
    ...
    },
    {
      ...
      answerWithProofs:
        'In my greatest sorrows and temptations I may be assured and comforted that my Lord Jesus Christ, by His unspeakable anguish, pain, terror, and agony, which He endured throughout all His sufferings[1] but especially on the cross, has delivered me from the anguish and torment of hell.[2]',
      proofs: [
        {
          id: 1,
          references:
    ...
    },
    {
      ...
      answerWithProofs:
        'That Christ, before the eyes of His disciples, was taken up from the earth into heaven,[1] and that He is there for our benefit[2] until He comes again to judge the living and the dead.[3]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      questionWithProofs:
        'Is Christ, then, not with us until the end of the world, as He has promised us?[1]',
      answer:
    ...
    },
    {
      ...
      answerWithProofs:
        'Christ ascended into heaven to manifest Himself there as Head of His Church,[1] through whom the Father governs all things.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'First, by His Holy Spirit He pours out heavenly gifts upon us, His members.[1] Second, by His power He defends and preserves us against all enemies.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'In all my sorrow and persecution I lift up my head and eagerly await as judge from heaven the very same person who before has submitted Himself to the judgment of God for my sake, and has removed all the curse from me.[1] He will cast all His and my enemies into everlasting condemnation, but He will take me and all His chosen ones to Himself into heavenly joy and glory.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'First, He is, together with the Father and the Son, true and eternal God.[1] Second, He is also given to me,[2] to make me by true faith share in Christ and all His benefits,[3] to comfort me,[4] and to remain with me forever.[5]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'First, that believers, all and everyone, as members of Christ have communion with Him and share in all His treasures and gifts.[1] Second, that everyone is duty-bound to use his gifts readily and cheerfully for the benefit and well-being of the other members.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        "I believe that God, because of Christ's satisfaction, will no more remember my sins,[1] nor my sinful nature, against which I have to struggle all my life,[2] but He will graciously grant me the righteousness of Christ, that I may never come into condemnation.[3]",
      proofs: [
        {
          id: 1,
          references:
    ...
    },
    {
      ...
      answerWithProofs:
        'Since I now already feel in my heart the beginning of eternal joy, [1] I shall after this life possess perfect blessedness, such as no eye has seen, nor ear heard, nor the heart of man conceived-- a blessedness in which to praise God forever.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'Not that I am acceptable to God on account of the worthiness of my faith, for only the satisfaction, righteousness, and holiness of Christ is my righteousness before God.[1] I can receive this righteousness and make it mine my own by faith only.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        "Because the righteousness which can stand before God's judgment must be absolutely perfect and in complete agreement with the law of God,[1] whereas even our best works in this life are all imperfect and defiled with sin.[2]",
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'No. It is impossible that those grafted into Christ by true faith should not bring forth fruits of thankfulness.[1]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'From the Holy Spirit,[1] who works it in our hearts by the preaching of the gospel,[2] and strengthens it by the use of the sacraments.[3]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        "Yes, indeed. The Holy Spirit teaches us in the gospel and assures us by the sacraments that our entire salvation rests on Christ's one sacrifice for us on the cross.[1]",
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs: 'Two: holy baptism and the holy supper.[1]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'In this way: Christ instituted this outward washing[1] and with it gave the promise that, as surely as water washes away the dirt from the body, so certainly His blood and Spirit wash away the impurity of my soul, that is, all my sins.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'No, only the blood of Jesus Christ and the Holy Spirit cleanse us from all sins.[1]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'God speaks in this way for a good reason. He wants to teach us that the blood and Spirit of Christ remove our sins just as water takes away dirt from the body.[1] But, even more important, He wants to assure us by this divine pledge and sign that we are as truly cleansed from our sins spiritually as we are bodily washed with water.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'No, for then the covenant of God would be profaned and His wrath kindled against the whole congregation.[1] Therefore, according to the command of Christ and His apostles, the Christian church is duty-bound to exclude such persons by the keys of the kingdom of heaven, until they amend their lives.',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        "According to the command of Christ, the kingdom of heaven is opened when it is proclaimed and publicly testified to each and every believer that God has really forgiven all their sins for the sake of Christ's merits, as often as they by true faith accept the promise of the gospel. The kingdom of heaven is closed when it is proclaimed and testified to all unbelievers and hypocrites that the wrath of God and eternal condemnation rest on them as long as they do not repent. According to this testimony of the gospel, God will judge both in this life and in the life to come.[1]",
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'Into two parts. The first teaches us how to live in relation to God; the second, what duties we owe our neighbour.[1]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answer:
        'That for the sake of my very salvation I avoid and flee all idolatry, witchcraft, superstition, and prayer to saints or to other creatures. Further, that I rightly come to know the only true God. trust in Him alone, submit to Him with all humility and patience, expect all good from Him only, and love, fear,[10] and honour Him[11] with all my heart. In short, that I forsake all creatures rather than do the least thing against His will.[12]',
      answerWithProofs:
    ...
    },
    {
      ...
      answerWithProofs:
        'Idolatry is having or inventing something in which to put our trust instead of, or in addition to, the only true God who has revealed Himself in His Word.[1]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'God cannot and may not be visibly portrayed in any way. Creatures may be portrayed, but God forbids us to make or have any images of them in order to worship them or to serve God through them.[1]',
      proofs: [
        {
          id: 1,
          references:
    ...
    },
    {
      ...
      answerWithProofs:
        'No, for we should not be wiser than God. He wants His people to be taught not by means of dumb images[1] but by the living preaching of His Word.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        "Certainly,[1] for no sin is greater or provokes God's wrath more than the blaspheming of His Name. That is why He commanded it to be punished with death.[2]",
      proofs: [
        {
          id: 1,
          references: 'Lev. 5:1',
    ...
    },
    {
      ...
      answerWithProofs:
        "Yes, when the government demands it of its subjects, or when necessity requires it, in order to maintain and promote fidelity and truth, to God's glory and for our neighbour's good. Such oath-taking is based on God's Word[1] and was therefore rightly used by saints in the Old and the New Testament.[2]",
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'No. A lawful oath is a calling upon God, who alone knows the heart, to bear witness to the truth, and to punish me if I swear falsely.[1] No creature is worthy of such honour.[2]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        "That I show all honour, love, and faithfulness to my father and mother and to all those in authority over me, submit myself with due obedience to their good instruction and discipline,[1] and also have patience with their weaknesses and shortcomings,[2] since it is God's will to govern us by their hand.[3]",
      proofs: [
        {
          id: 1,
          references:
    ...
    },
    {
      ...
      answerWithProofs:
        'By forbidding murder God teaches us that He hates the root of murder, such as envy, hatred, anger, and desire of revenge,[1] and that He regards all these as murder.[2]',
      proofs: [
        {
          id: 1,
          references:
    ...
    },
    {
      ...
      answerWithProofs:
        'No. When God condemns envy, hatred, and anger, He commands us to love our neighbour as ourselves,[1] to show patience, peace, gentleness, mercy, and friendliness toward him,[2] to protect him from harm as much as we can, and to do good even to our enemies.[3]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'That all unchastity is cursed by God.[1] We must therefore detest it from the heart[2] and live chaste and disciplined lives, both within and outside of holy marriage.[3]',
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        "Since we, body and soul, are temples of the Holy Spirit, it is God's will that we keep ourselves pure and holy. Therefore He forbids all unchaste acts, gestures, words, thoughts, desires,[1] and whatever may entice us to unchastity.[2]",
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        "I must promote my neighbour's good wherever I can and may, deal with him as I would like others to deal with me, and work faithfully so that I may be able to give to those in need.[1]",
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        "That not even the slightest thought or desire contrary to any of God's commandments should ever arise in our heart. Rather, we should always hate all sin with all our heart, and delight in all righteousness.[1]",
      proofs: [
        {
          id: 1,
    ...
    },
    {
      ...
      answerWithProofs:
        'No. In this life even the holiest have only a small beginning of this obedience.[1] Nevertheless, with earnest purpose they do begin to live not only according to some but to all the commandments of God.[2]',
      proofs: [
        {
          id: 1,
